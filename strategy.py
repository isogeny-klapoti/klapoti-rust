...
data = [416, 115, 86, 4662]

# 256
# data = [887, 429, 290, 17620]
# data = [889, 429, 290, 17620]

# 512
# data = [1638, 2782, 1967, 68776]
# data = [1640, 2782, 1967, 68776]

# 768
# data = [2407, 7892, 4766, 186800]
# data = [2408, 7892, 4766, 186800]

# 1024
# data = [3180, 13719, 7222, 361090]

# 1536
# data = [4722, 31497, 15469, 787660]
data = [4724, 31497, 15469, 787660]

# 2048
# data = [6222, 58426, 27475, 1441700]
